...
export const tr: PageCopy = {
  ...
  ar: { eyebrow: "AR macerası", title: "Koruyucu'nun dünyasına bak", text: "Telefonunuzun kamerasıyla Prohodna'nın gizli dünyasını canlandırın. AR katmanı çıplak gözle görünmeyen hikayeleri, işaretleri ve karakterleri, yalnızca gerçekleştiği yerlerde gösterir.", steps: ["Uygulamayı indir", "Aglen çevresindeki işaretli bir AR yerine gidin", "Kamerayı doğrultun ve gizli dünyayı görün"], cta: "İndir ve başla" },
  app: { eyebrow: "Uygulamayı indir", title: "Unlocking Bulgaria", text: "Android için mobil uygulama. Aglen çevresindeki görevleri bulun ve gerçek bir maceraya çıkın.", badge: "Unlocking Bulgaria'yı aç", note: "Uygulamanın resmi sitesi unlockingbulgaria.com/bg/." },
