...
export const tr: PageCopy = {
  ...
  quests: { eyebrow: "Bulgaristan'da türünün ilki", title: "Aglen yakınında gerçek bir AR macerası", text: "Hidden Bulgaria Quests sizi gerçek yerlere götürür - telefonunuzla gizli bir 3D dünya görür, bilmeceler çözer ve Koruyucu'nun izlerini takip edersiniz. Simülasyon değil. Müze değil. Gerçek bir canlı macera.", cta: "İndir ve başla", features: [
    { id: "augmented-reality", title: "Artırılmış Gerçeklik (AR)", text: "Kamerayı işaretli bir yere doğrultun ve gizli dünyanın gözlerinizin önünde canlandığını görün: 3D karakterler, işaretler ve hikayeler." },
    { id: "gps-missions", title: "Canlı GPS görevleri", text: "Yolculuklar sizi Aglen çevresindeki gerçek noktalara götürür. Her yer bir sonraki ipucunu saklar." },
    { id: "living-history", title: "Tarih farklı anlatılır", text: "Prohodna Mağarası'nın efsaneleri oyun olarak canlanır. Koruyucu, mağara, eski işaretler - hepsi tek bir deneyimde bağlantılıdır." },
  ] },
  ...
  experiencesList: [
    { id: "canyon-walk", title: "Kanyon yürüyüşü", price: negotiablePrice.tr, duration: "2-3 saat", bestFor: "İlk ziyaret", description: "Vit'e, kaya şekillerine ve yerel adlara rehberli bakış." },
    { id: "river-photo-journey", title: "Nehir fotoğraf rotası", price: negotiablePrice.tr, duration: "Yarım gün", bestFor: "Fotoğrafçılar", description: "Nehir, kayalar ve eski sokaklar çevresinde seçilmiş noktalar." },
    { id: "vit-fishing", title: "Vit'te balıkçılık", price: negotiablePrice.tr, duration: "2 saat", bestFor: "Yavaş seyahat", description: "Pratik yönlendirmeyle su kenarında sakin yerel ritim." },
    { id: "aglen-weekend", title: "Aglen hafta sonu", price: negotiablePrice.tr, duration: "2 gün", bestFor: "Çiftler ve arkadaşlar", description: "Yürüyüşler, piknik, el sanatları ve köy hikayeleri." },
    { id: "herbs-village-knowledge", title: "Otlar ve köy bilgisi", price: negotiablePrice.tr, duration: "90 dk", bestFor: "Meraklı gezginler", description: "Otları tanıma, geleneksel kullanım ve sorumlu toplama." },
    { id: "school-discovery-day", title: "Okul keşif günü", price: negotiablePrice.tr, duration: "1 gün", bestFor: "Okul grupları", description: "Coğrafya, tarih, yerel efsaneler ve doğa koruma rotası." },
  ],
  galleryItems: [
