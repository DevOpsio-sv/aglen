...
export const en: PageCopy = {
  ...
  quests: {
    ...
    features: [
      { title: "Augmented Reality (AR)", text: "Point the camera at a marked place and see the hidden world come alive before your eyes - 3D characters, signs, and stories." },
      { title: "Live GPS missions", text: "The journeys lead you to real landmarks around Aglen. Every place hides the next clue." },
      { title: "History, told differently", text: "The legends of Prohodna Cave come alive as a game. The Guardian, the cave, the ancient signs - everything is connected in one experience." },
    ],
  },
  ar: {
