...
export const en: PageCopy = {
  ...
  mysteries: [
    ...
    { title: "Rocks with local names", tag: "Folklore landscape", image: images.arch, description: "Names like Dupkata and Sloncheto make the landscape personal. They are landmarks and stories at the same time." },
  ],
  placesList: [
    { id: "dupkata", title: "Dupkata", tag: "Rock arch", image: images.caveCard, imageAlt: "Limestone rock arch above the river near Aglen", description: "A natural stone arch above the Vit, made for slow walks, quiet photos, and the feeling of a hidden route." },
    { id: "sloncheto", title: "Sloncheto", tag: "Rock figure", image: images.hero, imageAlt: "Canyon, river, and limestone cliffs near Aglen", description: "A playful riverside form that turns an ordinary walk into a small discovery." },
    { id: "chervena-stena", title: "The Red Cliff", tag: "Canyon view", image: images.riverSunsetCard, imageAlt: "Canyon landscape with river and village", description: "A dramatic meeting of limestone, forest, and river light near the village." },
