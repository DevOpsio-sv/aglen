...
export const es: PageCopy = {
  ...
  placesList: [
    { id: "dupkata", title: "Dupkata", tag: "Arco de roca", image: images.caveCard, imageAlt: "Ventana de roca con vista a un paisaje calizo cerca de Aglen", description: "Un arco natural de roca sobre el río Vit y uno de los lugares más fotogénicos alrededor de Aglen." },
    { id: "sloncheto", title: "Sloncheto", tag: "Figura de roca", image: images.hero, imageAlt: "Cañón, río y rocas calizas cerca de Aglen", description: "Una curiosa forma rocosa que se ha convertido en uno de los símbolos de la zona." },
    { id: "chervena-stena", title: "Chervena stena", tag: "Vista de cañón", image: images.riverSunsetCard, imageAlt: "El río Vit al atardecer con rocas y árboles cerca de Aglen", description: "Una vista impresionante del paisaje de cañón formado por las rocas y el río." },
    { id: "rachkov-vir", title: "Rachkov vir", tag: "Poza del río", image: images.nearbyRetreatCard, imageAlt: "Tranquila lámina de agua con casa de madera y orilla caliza cerca de Lukovit y Aglen", description: "Una pintoresca poza del río, ideal para descansar, hacer fotos, un jacuzzi natural en el río y pescar." },
