...
export const es: PageCopy = {
  ...
  ar: { eyebrow: "Aventura AR", title: "Mira el mundo del Guardián", text: "Con la cámara de tu teléfono, da vida al mundo oculto de Prohodna. La capa AR revela historias, señales y personajes invisibles a simple vista, pero solo en los lugares donde ocurrieron.", steps: ["Abre unlockingbulgaria.com/bg/", "Ve a un lugar AR marcado alrededor de Aglen", "Apunta la cámara y ve el mundo oculto"], cta: "Descargar y empezar" },
  app: { eyebrow: "Descargar la app", title: "unlockingbulgaria", text: "Aplicación móvil para Android. Encuentra las misiones alrededor de Aglen y emprende una aventura real.", badge: "Abrir unlockingbulgaria.com", note: "El sitio oficial de la app es unlockingbulgaria.com/bg/." },
