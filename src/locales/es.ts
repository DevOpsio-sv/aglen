...
export const es: PageCopy = {
  ...
  quests: { eyebrow: "El primero de su tipo en Bulgaria", title: "Una aventura AR real cerca de Aglen", text: "Unlocking Bulgaria te lleva a lugares reales - con tu teléfono ves un mundo 3D oculto, resuelves acertijos y sigues las huellas del Guardián. No es una simulación. No es un museo. Es una aventura real en vivo.", cta: "Descargar y empezar", features: [
