...
export const es: PageCopy = {
  ...
  quests: { eyebrow: "El primero de su tipo en Bulgaria", title: "Una aventura AR real cerca de Aglen", text: "Hidden Bulgaria Quests te lleva a lugares reales - con tu teléfono ves un mundo 3D oculto, resuelves acertijos y sigues las huellas del Guardián. No es una simulación. No es un museo. Es una aventura real en vivo.", cta: "Descargar y empezar", features: [
    { id: "augmented-reality", title: "Realidad Aumentada (AR)", text: "Apunta la cámara a un lugar marcado y ve cómo el mundo oculto cobra vida ante tus ojos: personajes 3D, señales e historias." },
    { id: "gps-missions", title: "Misiones GPS en vivo", text: "Los viajes te llevan a lugares reales alrededor de Aglen. Cada lugar esconde la siguiente pista." },
    { id: "living-history", title: "Historia contada de otra manera", text: "Las leyendas de la cueva Prohodna cobran vida como un juego. El Guardián, la cueva, los signos antiguos: todo está conectado en una experiencia." },
  ] },
  ...
  experiencesList: [
    { id: "canyon-walk", title: "Caminata por el cañón", price: negotiablePrice.es, duration: "2-3 horas", bestFor: "Primera visita", description: "Vistas guiadas hacia el Vit, formas de roca y los nombres locales detrás del paisaje." },
    { id: "river-photo-journey", title: "Viaje fotográfico del río", price: negotiablePrice.es, duration: "Medio día", bestFor: "Fotógrafos", description: "Lugares seleccionados junto al río, las rocas, las calles antiguas y la luz natural suave." },
    { id: "vit-fishing", title: "Pesca junto al Vit", price: negotiablePrice.es, duration: "2 horas", bestFor: "Viaje lento", description: "Un ritmo local tranquilo junto al agua con orientación práctica y cuidado por el río." },
    { id: "aglen-weekend", title: "Escapada de fin de semana en Aglen", price: negotiablePrice.es, duration: "2 días", bestFor: "Parejas y amigos", description: "Caminatas, picnic, artesanía y una ruta de tarde por historias del pueblo." },
    { id: "herbs-village-knowledge", title: "Hierbas y saber del pueblo", price: negotiablePrice.es, duration: "90 min.", bestFor: "Viajeros curiosos", description: "Reconocimiento de hierbas, usos tradicionales y recolección responsable." },
    { id: "school-discovery-day", title: "Día escolar de descubrimiento", price: negotiablePrice.es, duration: "1 día", bestFor: "Grupos escolares", description: "Una ruta de campo por geografía, historia, leyendas locales y protección de la naturaleza." },
  ],
  galleryItems: [
