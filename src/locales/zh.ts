...
export const zh: PageCopy = {
  ...
  quests: {
    ...
    cta: "下载并开始",
    features: [
      { id: "ar", title: "增强现实 (AR)", text: "将摄像头对准标记地点，隐藏世界会在眼前出现：3D 角色、符号和故事。" },
      { id: "gps", title: "实时 GPS 任务", text: "路线会带你到阿格伦周边真实地标。每个地点都藏着下一条线索。" },
      { id: "story", title: "换一种方式讲历史", text: "普罗霍德纳洞穴的传说变成游戏。守护者、洞穴和古老符号连接成一次完整体验。" },
    ],
  },
