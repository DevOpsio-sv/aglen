...
export const zh: PageCopy = {
  ...
  quests: {
    ...
    cta: "下载并开始",
    features: [
      { id: "augmented-reality", title: "增强现实 (AR)", text: "将摄像头对准标记地点，隐藏世界会在眼前出现：3D 角色、符号和故事。" },
      { id: "gps-missions", title: "实时 GPS 任务", text: "路线会带你到阿格伦周边真实地标。每个地点都藏着下一条线索。" },
      { id: "living-history", title: "换一种方式讲历史", text: "普罗霍德纳洞穴的传说变成游戏。守护者、洞穴和古老符号连接成一次完整体验。" },
    ],
  },
  ...
  experiencesList: [
    { id: "canyon-walk", title: "峡谷步行", price: negotiablePrice.zh, duration: "2-3 小时", bestFor: "首次访问", description: "由向导带你看维特河、岩形和景观背后的地方名字。" },
    { id: "river-photo-journey", title: "河边摄影旅程", price: negotiablePrice.zh, duration: "半天", bestFor: "摄影者", description: "选择河流、岩石、旧村街和柔和自然光附近的拍摄点。" },
    { id: "vit-fishing", title: "维特河钓鱼", price: negotiablePrice.zh, duration: "2 小时", bestFor: "慢旅行", description: "在水边感受安静节奏，配合实用指引并保护河流。" },
    { id: "aglen-weekend", title: "阿格伦周末小逃离", price: negotiablePrice.zh, duration: "2 天", bestFor: "情侣与朋友", description: "步行、野餐、手工艺和穿过村庄故事的晚间路线。" },
    { id: "herbs-village-knowledge", title: "草药与村庄知识", price: negotiablePrice.zh, duration: "90 分钟", bestFor: "好奇旅行者", description: "认识草药、传统用途和负责任采集。" },
    { id: "school-discovery-day", title: "学生发现日", price: negotiablePrice.zh, duration: "1 天", bestFor: "学生团体", description: "连接地理、历史、地方传说和自然保护的实地路线。" },
  ],
  galleryItems: [
