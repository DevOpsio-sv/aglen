...
export const fr: PageCopy = {
  ...
  landmarks: { eyebrow: "Lieux à découvrir", title: "Découvrez les plus beaux endroits autour d'Aglen", text: "Des formations rocheuses impressionnantes et des bassins fluviaux aux panoramas et sites historiques – ici, la nature et les légendes locales transforment chaque promenade en petite découverte.", aria: "Étapes autour d'Aglen" },
