...
export const fr: PageCopy = {
  ...
  quests: {
    ...
    features: [
      { title: "Réalité augmentée (AR)", text: "Pointez la caméra vers un lieu marqué et voyez le monde caché prendre vie sous vos yeux: personnages 3D, signes et histoires." },
      { title: "Missions GPS en direct", text: "Les voyages vous mènent vers de vrais sites autour d'Aglen. Chaque lieu cache l'indice suivant." },
      { title: "L'histoire autrement", text: "Les légendes de la grotte de Prohodna prennent vie comme un jeu. Le Gardien, la grotte, les signes anciens: tout est relié dans une seule expérience." },
    ],
  },
