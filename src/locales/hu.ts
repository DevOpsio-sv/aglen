...
export const hu: PageCopy = {
  ...
  ar: { eyebrow: "AR-kaland", title: "Lásd az Őrző világát", text: "Telefonod kamerájával életre keltheted Prohodna rejtett világát. Az AR-réteg történeteket, jeleket és szereplőket mutat meg ott, ahol a történetek helyszíne van.", steps: ["Töltsd le az alkalmazást", "Menj egy jelölt AR-helyre Aglen körül", "Irányítsd a kamerát, és lásd a rejtett világot"], cta: "Letöltés és kezdés" },
  app: { eyebrow: "Alkalmazás letöltése", title: "Unlocking Bulgaria", text: "Androidos mobilalkalmazás. Találd meg a küldetéseket Aglen körül, és indulj valódi kalandra.", badge: "Unlocking Bulgaria megnyitása", note: "Az alkalmazás hivatalos webhelye: unlockingbulgaria.com/bg/." },
  ...
  experiencesList: [
    { id: "canyonWalk", title: "Kanyonséta", price: negotiablePrice.hu, duration: "2-3 óra", bestFor: "Első látogatás", description: "Vezetett kilátások a Vitre, sziklaformákra és a táj mögötti helyi nevekre." },
    { id: "photoTour", title: "Folyóparti fotóút", price: negotiablePrice.hu, duration: "Fél nap", bestFor: "Fotósok", description: "Kiválasztott helyek a folyónál, szikláknál, régi falusi utcáknál és lágy természetes fényben." },
    { id: "fishing", title: "Horgászat a Vitnél", price: negotiablePrice.hu, duration: "2 óra", bestFor: "Lassú utazás", description: "Csendes helyi ritmus a víznél, gyakorlati tanácsokkal és a folyó védelmével." },
    { id: "weekendEscape", title: "Agleni hétvégi menekülés", price: negotiablePrice.hu, duration: "2 nap", bestFor: "Párok és barátok", description: "Séták, piknik, kézművesség és esti útvonal falusi történeteken át." },
    { id: "herbs", title: "Gyógynövények és falusi tudás", price: negotiablePrice.hu, duration: "90 perc", bestFor: "Kíváncsi utazók", description: "Gyógynövények felismerése, hagyományos használat és felelős gyűjtés." },
    { id: "schoolDay", title: "Iskolai felfedezőnap", price: negotiablePrice.hu, duration: "1 nap", bestFor: "Diákcsoportok", description: "Terepi útvonal földrajzon, történelmen, helyi legendákon és természetvédelmen át." },
  ],
  galleryItems: [
