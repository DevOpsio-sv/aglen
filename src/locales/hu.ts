...
export const hu: PageCopy = {
  ...
  quests: {
    ...
    features: [
      { title: "Kiterjesztett valóság (AR)", text: "Irányítsd a kamerát egy jelölt helyre, és a rejtett világ életre kel: 3D szereplők, jelek és történetek." },
      { title: "Élő GPS-küldetések", text: "Az utak Aglen valódi látnivalóihoz vezetnek. Minden hely új nyomot rejt." },
      { title: "Másképp elmesélt történelem", text: "Prohodna barlang legendái játékká válnak. Az Őrző, a barlang és az ősi jelek egy élménnyé kapcsolódnak." },
    ],
  },
  ...
  experiencesList: [
    ...
    { title: "Folyóparti fotóút", price: negotiablePrice.hu, duration: "Fél nap", bestFor: "Fotósok", description: "Kiválasztott helyek a folyónál, szikláknál, régi falusi utcáknál és lágy természetes fényben." },
    { title: "Horgászat a Vitnél", price: negotiablePrice.hu, duration: "2 óra", bestFor: "Lassú utazás", description: "Csendes helyi ritmus a víznél, gyakorlati tanácsokkal és a folyó védelmével." },
    { title: "Agleni hétvégi menekülés", price: negotiablePrice.hu, duration: "2 nap", bestFor: "Párok és barátok", description: "Séták, piknik, kézművesség és esti útvonal falusi történeteken át." },
    { title: "Gyógynövények és falusi tudás", price: negotiablePrice.hu, duration: "90 perc", bestFor: "Kíváncsi utazók", description: "Gyógynövények felismerése, hagyományos használat és felelős gyűjtés." },
    { title: "Iskolai felfedezőnap", price: negotiablePrice.hu, duration: "1 nap", bestFor: "Diákcsoportok", description: "Terepi útvonal földrajzon, történelmen, helyi legendákon és természetvédelmen át." },
  ],
  galleryItems: [
