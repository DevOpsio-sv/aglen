...
export const it: PageCopy = {
  ...
  ar: { eyebrow: "Avventura AR", title: "Guarda il mondo del Guardiano", text: "Con la fotocamera del telefono dai vita al mondo nascosto di Prohodna. Il livello AR rivela storie, segni e personaggi invisibili a occhio nudo, ma solo nei luoghi in cui sono accaduti.", steps: ["Apri unlockingbulgaria.com/bg/", "Vai a un luogo AR segnato intorno ad Aglen", "Punta la fotocamera e scopri il mondo nascosto"], cta: "Scarica e inizia" },
  app: { eyebrow: "Scarica l'app", title: "unlockingbulgaria", text: "App mobile per Android. Trova le missioni intorno ad Aglen e parti per una vera avventura.", badge: "Apri unlockingbulgaria.com", note: "Il sito ufficiale dell'app è unlockingbulgaria.com/bg/." },
