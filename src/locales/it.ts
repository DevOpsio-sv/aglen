...
export const it: PageCopy = {
  ...
  quests: { eyebrow: "Primo nel suo genere in Bulgaria", title: "Una vera avventura AR vicino ad Aglen", text: "Hidden Bulgaria Quests ti porta in luoghi reali - con il telefono vedi un mondo 3D nascosto, risolvi enigmi e segui le tracce del Guardiano. Non una simulazione. Non un museo. Una vera avventura dal vivo.", cta: "Scarica e inizia", features: [
    { id: "ar", title: "Realtà aumentata (AR)", text: "Punta la fotocamera verso un luogo segnato e guarda il mondo nascosto prendere vita davanti ai tuoi occhi: personaggi 3D, segni e storie." },
    { id: "gps", title: "Missioni GPS dal vivo", text: "I viaggi ti portano a vere attrazioni intorno ad Aglen. Ogni luogo nasconde l'indizio successivo." },
    { id: "story", title: "Storia raccontata diversamente", text: "Le leggende della grotta Prohodna prendono vita come gioco. Il Guardiano, la grotta, gli antichi segni: tutto è collegato in un'unica esperienza." },
  ] },
