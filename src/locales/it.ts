...
export const it: PageCopy = {
  nav: { home: "Home", about: "Su Aglen", landmarks: "Attrazioni", stay: "Soggiorno", quests: "Hidden Bulgaria Quests" },
  ...
  experiences: { eyebrow: "Scegli il tuo weekend ad Aglen", title: "Momenti guidati, non una lista turistica", text: "Le escursioni sono modellate come esperienze chiare: abbastanza brevi per un weekend, abbastanza personali da sembrare locali.", cta: "Chiedi il percorso" },
  ...
  quests: { eyebrow: "Primo nel suo genere in Bulgaria", title: "Una vera avventura AR vicino ad Aglen", text: "Hidden Bulgaria Quests ti porta in luoghi reali - con il telefono vedi un mondo 3D nascosto, risolvi enigmi e segui le tracce del Guardiano. Non una simulazione. Non un museo. Una vera avventura dal vivo.", cta: "Scarica e inizia", features: [
    { id: "augmented-reality", title: "Realtà aumentata (AR)", text: "Punta la fotocamera verso un luogo segnato e guarda il mondo nascosto prendere vita davanti ai tuoi occhi: personaggi 3D, segni e storie." },
    { id: "gps-missions", title: "Missioni GPS dal vivo", text: "I viaggi ti portano a vere attrazioni intorno ad Aglen. Ogni luogo nasconde l'indizio successivo." },
    { id: "living-history", title: "Storia raccontata diversamente", text: "Le leggende della grotta Prohodna prendono vita come gioco. Il Guardiano, la grotta, gli antichi segni: tutto è collegato in un'unica esperienza." },
  ] },
  ...
  experiencesList: [
    { id: "canyon-walk", title: "Passeggiata nel canyon", price: negotiablePrice.it, duration: "2-3 ore", bestFor: "Prima visita", description: "Viste guidate verso il Vit, forme rocciose e nomi locali del paesaggio." },
    { id: "river-photo-journey", title: "Viaggio fotografico sul fiume", price: negotiablePrice.it, duration: "Mezza giornata", bestFor: "Fotografi", description: "Luoghi scelti intorno al fiume, alle rocce e alle vecchie strade." },
    { id: "vit-fishing", title: "Pesca sul Vit", price: negotiablePrice.it, duration: "2 ore", bestFor: "Viaggio lento", description: "Ritmo locale calmo sull'acqua con consigli pratici." },
    { id: "aglen-weekend", title: "Weekend ad Aglen", price: negotiablePrice.it, duration: "2 giorni", bestFor: "Coppie e amici", description: "Passeggiate, picnic, artigianato e storie serali del villaggio." },
    { id: "herbs-village-knowledge", title: "Erbe e sapere del villaggio", price: negotiablePrice.it, duration: "90 min", bestFor: "Viaggiatori curiosi", description: "Riconoscere erbe, usi tradizionali e raccolta responsabile." },
    { id: "school-discovery-day", title: "Giornata scoperta per scuole", price: negotiablePrice.it, duration: "1 giorno", bestFor: "Gruppi scolastici", description: "Un percorso tra geografia, storia, leggende locali e natura." },
  ],
  galleryItems: [
  ...
  mapStops: [
    { title: "Il centro del villaggio", detail: "Inizia dalla scala umana di Aglen: strade, chiesa, memoria locale e orientamento." },
    { title: "Il sentiero lungo il Vit", detail: "Segui l'acqua verso viste tranquille, curve e luoghi ombreggiati per la fotografia." },
    { title: "Дупката", detail: "Una soglia naturale di pietra e uno dei forti simboli visivi della destinazione." },
