...
export const ja: PageCopy = {
  ...
  quests: { eyebrow: "ブルガリア初の体験", title: "アグレン近くのリアルARアドベンチャー", text: "Unlocking Bulgaria は実在する場所へ案内します。スマートフォンで隠れた3D世界を見て、謎を解き、守護者の痕跡をたどります。シミュレーションではありません。博物館でもありません。本物のライブアドベンチャーです。", cta: "ダウンロードして始める", features: [
