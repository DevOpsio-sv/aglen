...
export const ja: PageCopy = {
  ...
  quests: { eyebrow: "ブルガリア初の体験", title: "アグレン近くのリアルARアドベンチャー", text: "Hidden Bulgaria Questsは実在する場所へ案内します。スマートフォンで隠れた3D世界を見て、謎を解き、守護者の痕跡をたどります。シミュレーションではありません。博物館でもありません。本物のライブアドベンチャーです。", cta: "ダウンロードして始める", features: [
    { id: "ar", title: "拡張現実（AR）", text: "マークされた場所にカメラを向けると、隠れた世界が目の前で生き生きとします。3Dキャラクター、サイン、物語が現れます。" },
    { id: "gps", title: "ライブGPSミッション", text: "旅はアグレン周辺の実在する見どころへ案内します。各場所が次の手がかりを隠しています。" },
    { id: "story", title: "違う形で語られる歴史", text: "プロホドナ洞窟の伝説がゲームとして生き生きとします。守護者、洞窟、古代の印、すべてが一つの体験としてつながります。" },
  ] },
