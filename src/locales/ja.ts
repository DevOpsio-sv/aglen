...
export const ja: PageCopy = {
  ...
  quests: { eyebrow: "ブルガリア初の体験", title: "アグレン近くのリアルARアドベンチャー", text: "Hidden Bulgaria Questsは実在する場所へ案内します。スマートフォンで隠れた3D世界を見て、謎を解き、守護者の痕跡をたどります。シミュレーションではありません。博物館でもありません。本物のライブアドベンチャーです。", cta: "ダウンロードして始める", features: [
    { id: "augmented-reality", title: "拡張現実（AR）", text: "マークされた場所にカメラを向けると、隠れた世界が目の前で生き生きとします。3Dキャラクター、サイン、物語が現れます。" },
    { id: "gps-missions", title: "ライブGPSミッション", text: "旅はアグレン周辺の実在する見どころへ案内します。各場所が次の手がかりを隠しています。" },
    { id: "living-history", title: "違う形で語られる歴史", text: "プロホドナ洞窟の伝説がゲームとして生き生きとします。守護者、洞窟、古代の印、すべてが一つの体験としてつながります。" },
  ] },
  ...
  experiencesList: [
    { id: "canyon-walk", title: "峡谷ウォーク", price: negotiablePrice.ja, duration: "2-3時間", bestFor: "初めての訪問", description: "ヴィト川、岩の形、風景に残る地元名をガイドと一緒にたどります。" },
    { id: "river-photo-journey", title: "川辺の写真旅", price: negotiablePrice.ja, duration: "半日", bestFor: "写真好き", description: "川、岩、古い村道、やわらかな自然光の撮影ポイントを巡ります。" },
    { id: "vit-fishing", title: "ヴィト川での釣り", price: negotiablePrice.ja, duration: "2時間", bestFor: "スロートラベル", description: "川を大切にしながら、実用的な案内とともに水辺の静かなリズムを楽しみます。" },
    { id: "aglen-weekend", title: "アグレン週末エスケープ", price: negotiablePrice.ja, duration: "2日", bestFor: "カップルと友人", description: "散策、ピクニック、手仕事、村の物語をたどる夕方のルートです。" },
    { id: "herbs-village-knowledge", title: "ハーブと村の知恵", price: negotiablePrice.ja, duration: "90分", bestFor: "好奇心ある旅行者", description: "ハーブの見分け方、伝統的な使い方、責任ある採取を学びます。" },
    { id: "school-discovery-day", title: "学校向け発見の日", price: negotiablePrice.ja, duration: "1日", bestFor: "学生グループ", description: "地理、歴史、地元伝説、自然保護を結ぶフィールドルートです。" },
  ],
  galleryItems: [
