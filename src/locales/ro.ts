...
export const ro: PageCopy = {
  ...
  placesList: [
    { id: "dupkata", title: "Dupkata", tag: "Arcă de stâncă", image: images.caveCard, imageAlt: "Fereastră de stâncă cu vedere spre peisajul calcaros de lângă Aglen", description: "Arcă naturală de stâncă deasupra râului Vit și unul dintre cele mai fotogenice locuri din jurul Aglen." },
    { id: "sloncheto", title: "Sloncheto", tag: "Figură de stâncă", image: images.hero, imageAlt: "Canion, râu și stânci calcaroase lângă Aglen", description: "O formă de stâncă curioasă, devenită unul dintre simbolurile zonei." },
    { id: "chervena-stena", title: "Chervena stena", tag: "Vedere de canion", image: images.riverSunsetCard, imageAlt: "Râul Vit la apus, cu stânci și copaci lângă Aglen", description: "Priveliște impresionantă spre peisajul de canion, modelat de stânci și de râu." },
    { id: "rachkov-vir", title: "Rachkov vir", tag: "Bulboană de râu", image: images.nearbyRetreatCard, imageAlt: "Bulboană liniștită cu o căsuță de lemn și mal calcaros lângă Lukovit și Aglen", description: "Bulboană pitorească de râu, potrivită pentru odihnă, fotografii, jacuzzi natural și pescuit." },
