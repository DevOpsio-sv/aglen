...
export const ro: PageCopy = {
  ...
  ar: { eyebrow: "Aventură AR", title: "Privește lumea Gardianului", text: "Cu camera telefonului dai viață lumii ascunse din Prohodna. Stratul AR dezvăluie povești, semne și personaje invizibile cu ochiul liber, dar numai în locurile unde s-au petrecut.", steps: ["Descarcă aplicația", "Mergi la un loc AR marcat în jurul Aglen", "Îndreaptă camera și vezi lumea ascunsă"], cta: "Descarcă și începe" },
  app: { eyebrow: "Descarcă aplicația", title: "Unlocking Bulgaria", text: "Aplicație mobilă pentru Android. Găsește questurile din jurul Aglen și pornește într-o aventură reală.", badge: "Deschide Unlocking Bulgaria", note: "Site-ul oficial al aplicației este unlockingbulgaria.com/bg/." },
