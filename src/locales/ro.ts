...
export const ro: PageCopy = {
  ...
  ar: { eyebrow: "Aventură AR", title: "Privește lumea Gardianului", text: "Cu camera telefonului dai viață lumii ascunse din Prohodna. Stratul AR dezvăluie povești, semne și personaje invizibile cu ochiul liber, dar numai în locurile unde s-au petrecut.", steps: ["Deschide unlockingbulgaria.com/bg/", "Mergi la un loc AR marcat în jurul Aglen", "Îndreaptă camera și vezi lumea ascunsă"], cta: "Descarcă și începe" },
  app: { eyebrow: "Descarcă aplicația", title: "unlockingbulgaria", text: "Aplicație mobilă pentru Android. Găsește questurile din jurul Aglen și pornește într-o aventură reală.", badge: "Deschide unlockingbulgaria.com", note: "Site-ul oficial al aplicației este unlockingbulgaria.com/bg/." },
  ...
  experiencesList: [
    { id: "canyonWalk", title: "Plimbare prin canion", price: negotiablePrice.ro, duration: "2-3 ore", bestFor: "Prima vizită", description: "Priveliști ghidate spre Vit, forme de stâncă și nume locale." },
    { id: "photoTour", title: "Călătorie foto pe râu", price: negotiablePrice.ro, duration: "Jumătate de zi", bestFor: "Fotografi", description: "Locuri alese lângă râu, stânci și străzi vechi." },
    { id: "fishing", title: "Pescuit pe Vit", price: negotiablePrice.ro, duration: "2 ore", bestFor: "Slow travel", description: "Ritm local liniștit lângă apă cu sfaturi practice." },
    { id: "weekendEscape", title: "Weekend în Aglen", price: negotiablePrice.ro, duration: "2 zile", bestFor: "Cupluri și prieteni", description: "Plimbări, picnic, meșteșuguri și povești de seară." },
    { id: "herbs", title: "Plante și cunoaștere sătească", price: negotiablePrice.ro, duration: "90 min", bestFor: "Călători curioși", description: "Recunoașterea plantelor, utilizări tradiționale și cules responsabil." },
    { id: "schoolDay", title: "Zi de descoperire pentru școli", price: negotiablePrice.ro, duration: "1 zi", bestFor: "Grupuri școlare", description: "Traseu de teren prin geografie, istorie, legende și natură." },
  ],
  galleryItems: [
