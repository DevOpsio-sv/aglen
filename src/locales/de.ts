...
export const de: PageCopy = {
  ...
  quests: { eyebrow: "Das erste seiner Art in Bulgarien", title: "Ein echtes AR-Abenteuer bei Aglen", text: "Hidden Bulgaria Quests führt dich zu realen Orten - mit deinem Telefon siehst du eine verborgene 3D-Welt, löst Rätsel und folgst den Spuren des Wächters. Keine Simulation. Kein Museum. Ein echtes Live-Abenteuer.", cta: "Herunterladen und starten", features: [
    { id: "ar", title: "Augmented Reality (AR)", text: "Richte die Kamera auf einen markierten Ort und sieh, wie die verborgene Welt vor deinen Augen lebendig wird - 3D-Figuren, Zeichen und Geschichten." },
    { id: "gps", title: "Live-GPS-Missionen", text: "Die Reisen führen dich zu realen Sehenswürdigkeiten rund um Aglen. Jeder Ort verbirgt den nächsten Hinweis." },
    { id: "story", title: "Geschichte, anders erzählt", text: "Die Legenden der Höhle Prohodna werden als Spiel lebendig. Der Wächter, die Höhle, die alten Zeichen - alles ist in einem Erlebnis verbunden." },
  ] },
