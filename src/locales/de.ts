...
export const de: PageCopy = {
  ...
  placesList: [
    { id: "dupkata", title: "Dupkata", tag: "Felsbogen", image: images.caveCard, imageAlt: "Felsfenster mit Blick auf die Kalksteinlandschaft bei Aglen", description: "Ein natürlicher Felsbogen über dem Fluss Vit und einer der fotogensten Orte rund um Aglen." },
    { id: "sloncheto", title: "Слончето", tag: "Felsfigur", image: images.hero, imageAlt: "Canyon, Fluss und Kalksteinfelsen bei Aglen", description: "Eine neugierig anmutende Felsform, die zu einem der Wahrzeichen der Region geworden ist." },
    { id: "chervena-stena", title: "Червена стена", tag: "Canyonblick", image: images.riverSunsetCard, imageAlt: "Fluss Vit bei Sonnenuntergang mit Felsen und Bäumen bei Aglen", description: "Ein beeindruckender Blick auf die Canyonlandschaft, geformt von den Felsen und dem Fluss." },
    { id: "rachkov-vir", title: "Рачков вир", tag: "Flussbecken", image: images.nearbyRetreatCard, imageAlt: "Ruhiges Gewässer mit Holzhaus und Kalksteinufer bei Lukovit und Aglen", description: "Ein malerisches Flussbecken, geeignet für Erholung, Fotos, ein natürliches Flussbad und zum Angeln." },
