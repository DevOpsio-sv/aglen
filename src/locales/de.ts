...
export const de: PageCopy = {
  ...
  quests: { eyebrow: "Das erste seiner Art in Bulgarien", title: "Ein echtes AR-Abenteuer bei Aglen", text: "Hidden Bulgaria Quests führt dich zu realen Orten - mit deinem Telefon siehst du eine verborgene 3D-Welt, löst Rätsel und folgst den Spuren des Wächters. Keine Simulation. Kein Museum. Ein echtes Live-Abenteuer.", cta: "Herunterladen und starten", features: [
    { id: "augmented-reality", title: "Augmented Reality (AR)", text: "Richte die Kamera auf einen markierten Ort und sieh, wie die verborgene Welt vor deinen Augen lebendig wird - 3D-Figuren, Zeichen und Geschichten." },
    { id: "gps-missions", title: "Live-GPS-Missionen", text: "Die Reisen führen dich zu realen Sehenswürdigkeiten rund um Aglen. Jeder Ort verbirgt den nächsten Hinweis." },
    { id: "living-history", title: "Geschichte, anders erzählt", text: "Die Legenden der Höhle Prohodna werden als Spiel lebendig. Der Wächter, die Höhle, die alten Zeichen - alles ist in einem Erlebnis verbunden." },
  ] },
  ...
  experiencesList: [
    { id: "canyon-walk", title: "Canyon-Spaziergang", price: negotiablePrice.de, duration: "2-3 Stunden", bestFor: "Erstbesucher", description: "Geführte Blicke zum Vit, zu Felsformen und zu den lokalen Namen hinter der Landschaft." },
    { id: "river-photo-journey", title: "Foto-Reise am Fluss", price: negotiablePrice.de, duration: "Halber Tag", bestFor: "Fotografen", description: "Ausgewählte Orte am Fluss, bei den Felsen, alten Dorfstraßen und weichem Naturlicht." },
    { id: "vit-fishing", title: "Angeln am Vit", price: negotiablePrice.de, duration: "2 Stunden", bestFor: "Langsames Reisen", description: "Ein ruhiger lokaler Rhythmus am Wasser mit praktischer Anleitung und Sorgfalt für den Fluss." },
    { id: "aglen-weekend", title: "Wochenendflucht nach Aglen", price: negotiablePrice.de, duration: "2 Tage", bestFor: "Paare und Freunde", description: "Spaziergänge, Picknickzeit, Handwerk und eine Abendroute durch Dorfgeschichten." },
    { id: "herbs-village-knowledge", title: "Kräuter und Dorfwissen", price: negotiablePrice.de, duration: "90 Min.", bestFor: "Neugierige Reisende", description: "Kräuter erkennen, traditionelle Verwendung verstehen und verantwortungsvoll in der Landschaft sammeln." },
    { id: "school-discovery-day", title: "Entdeckungstag für Schulen", price: negotiablePrice.de, duration: "1 Tag", bestFor: "Schulgruppen", description: "Eine Feldroute durch Geografie, Geschichte, lokale Legenden und Naturschutz." },
  ],
  galleryItems: [
