...
export const bg: PageCopy = {
  ...
  quests: {
    ...
    title: "Открий скритата страна на Ъглен",
    text: "Hidden Bulgaria Quests е мобилно приключение, което те завежда на реални места около Ъглен. Разреши загадки, следвай следи и открий историите, скрити в скалите, реката и гората. Подходящо за всяка възраст.",
    cta: "Стартирай приключението",
  },
  ar: {
