...
export const bg: PageCopy = {
  ...
  quests: {
    ...
    features: [
      ...
      { title: "История, разказана различно", text: "Легендите на Ъглен оживяват като игра. Пазителят, пещерите, реката - всичко е свързано в едно преживяване." },
    ],
  },
  ar: {
    eyebrow: "AR приключение",
    title: "Погледни света на Пазителя",
    text: "С камерата на телефона си оживи скрития свят на Ъглен. AR слоят разкрива истории, знаци и персонажи, невидими с просто око — директно на местата, където са се случили.",
    steps: [
      "Изтегли Hidden Bulgaria Quests от Google Play",
      "Отиди на обозначено AR място в Ъглен",
  ...
  app: {
    ...
    text: "Безплатно мобилно приложение за Android. Намери квестовете около Ъглен и тръгни на истинско приключение.",
