...
export const bg: PageCopy = {
  ...
  quests: {
    ...
    title: "Истинско AR приключение в Ъглен",
    ...
    features: [
      { title: "Augmented Reality", text: "Насочи камерата към обозначено място и виж как скритият свят оживява пред очите ти — 3D персонажи, знаци и истории." },
      { title: "GPS квестове на живо", text: "Квестовете те водят до реални забележителности около Ъглен. Всяко място крие следваща улика." },
