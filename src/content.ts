...
export const contentByLanguage: Record<LanguageCode, PageCopy> = {
  bg: {
    ...
    sourceNotes: ["Оригинален Wix сайт и услуги: https://vasilevasilvena.wixsite.com/aglen", "Публичен исторически и туристически контекст: Banker.bg, Trip.dir.bg, BTA/Utro, Wikipedia/Wikitravel.", "Генерираните визуализации са временни до финални одобрени снимки от Ъглен."],
  },
  en: {
